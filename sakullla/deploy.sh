...
curl -o /etc/nginx/nginx.conf https://raw.githubusercontent.com/xinyiiy/Emby_nginx_proxy/refs/heads/main/sakullla/nginx.conf
...
curl -o "$you_domain_config.conf" "https://raw.githubusercontent.com/xinyiiy/Emby_nginx_proxy/main/sakullla/conf.d/$download_domain_config.conf"
